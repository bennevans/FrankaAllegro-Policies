...
from tactile_learning.tactile_data import TactileImageCurved, TactileCurvedRepresentation
...
class DexterityEnv(gym.Env):
    def __init__(
        ...
        if 'tactile' in data_representations:
            ...
            self.tactile_repr = TactileCurvedRepresentation(
    ...
    def _get_obs(self):
        ...
        for data_name in self.data_reprs:
            ...
            # Features
            elif 'allegro' == data_name:
                feature_arr.append(features_dict[data_name]['position'])
            elif data_name == 'kinova' or data_name == 'franka': # Arms are added in the end in order to have consistency
